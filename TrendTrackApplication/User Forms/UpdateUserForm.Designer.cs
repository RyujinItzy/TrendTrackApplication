namespace TrendTrackApplication.User_Forms
{
    partial class UpdateUserForm
    {
        ...
        {
            panel1 = new Panel();
            btn_user_update = new RoundedButton();
            ...
            panel1.Controls.Add(btn_user_update);
            ...
            // btn_user_update
            // 
            btn_user_update.BackColor = Color.Navy;
            btn_user_update.BackGroundColor = Color.Navy;
            btn_user_update.BorderColor = Color.RoyalBlue;
            btn_user_update.BorderRadius = 10;
            btn_user_update.BorderSize = 0;
            btn_user_update.FlatAppearance.BorderSize = 0;
            btn_user_update.FlatStyle = FlatStyle.Flat;
            btn_user_update.Font = new Font("Cambria", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btn_user_update.ForeColor = Color.White;
            btn_user_update.Location = new Point(376, 291);
            btn_user_update.Name = "btn_user_update";
            btn_user_update.Size = new Size(105, 31);
            btn_user_update.TabIndex = 20;
            btn_user_update.Text = "Update";
            btn_user_update.TextColor = Color.White;
            btn_user_update.UseVisualStyleBackColor = false;
            btn_user_update.Click += btn_user_update_Click;
            // 
            // btn_users_clear
            // 
        ...
        private RoundedButton btn_user_update;
